...
## Execute:
1. Use SearXNG search script with iterative query refinement (minimum 10 searches)
...
## Tools to Use:
- SearXNG Search: python3 ~/.claude/skills/deep-research/scripts/search.py "query" --json --num 10
